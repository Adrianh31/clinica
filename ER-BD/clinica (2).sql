...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-07-2014 a las 04:34:53
...
CREATE TABLE IF NOT EXISTS `cita` (
  ...
  PRIMARY KEY (`ID_CITA`,`ID_PACIENTE`,`ID_ESTADO_CITA`,`ID_EMPLEADO`),
  KEY `fk_CITA_PACIENTE1_idx` (`ID_PACIENTE`),
  KEY `fk_CITA_TIPO_CONSULTA1_idx` (`ID_ESTADO_CITA`),
  KEY `fk_CITA_EMPLEADO1_idx` (`ID_EMPLEADO`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
INSERT INTO `examen` (`ID_EXAMEN`, `NOMBRE`, `DESCRIPCION`, `VALOR_NORMAL`, `VALOR_MENOR`, `VALOR_SUPERIOR`) VALUES
(1, 'Sangre', NULL, NULL, NULL, NULL),
(2, 'Orina', NULL, NULL, NULL, NULL),
(3, 'Cardiograma', NULL, NULL, NULL, NULL),
(4, 'Radiografia', NULL, NULL, NULL, NULL);
...
ALTER TABLE `cita`
  ...
  ADD CONSTRAINT `fk_CITA_EMPLEADO1` FOREIGN KEY (`ID_EMPLEADO`) REFERENCES `empleado` (`ID_EMPLEADO`) ON DELETE NO ACTION ON UPDATE NO ACTION;
